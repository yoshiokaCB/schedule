...
class TimetablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create timetable" do
    assert_difference('Timetable.count') do
      post timetables_url, params: { timetable: { datetime: @timetable.datetime, endtime: @timetable.endtime, starttime: @timetable.starttime } }
    end
  ...
  test "should update timetable" do
    patch timetable_url(@timetable), params: { timetable: { datetime: @timetable.datetime, endtime: @timetable.endtime, starttime: @timetable.starttime } }
